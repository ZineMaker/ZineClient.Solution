...
namespace ZineClient.Migrations
{
    ...
    [Migration("20200408224605_ModifySeededData")]
            ...
            modelBuilder.Entity("ZineClient.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "35c1a1cf-4780-4df4-97c9-9dff35eeecf9",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "0d679cc8-a934-4dfa-a33c-649b05bfc16b",
            ...
            modelBuilder.Entity("ZineClient.Models.Post", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Published = new DateTime(2020, 4, 8, 15, 46, 4, 356, DateTimeKind.Local).AddTicks(2126),
                        ...
                        new
                        {
                            ...
                            MainImageUrl = "https://www.westsideseattle.com/sites/default/files/images/%5Bdomain-url%5D/%5Bnode-yyyy%5D/%5Bnode-mm%5D/252a9949_copy.jpg",
                            Published = new DateTime(2020, 4, 8, 15, 46, 4, 356, DateTimeKind.Local).AddTicks(2606),
                        ...
                        new
                        {
                            ...
                            MainImageUrl = "https://d3h6k4kfl8m9p0.cloudfront.net/uploads/2014/04/1920-washington-DC-shorpy.jpg",
                            Published = new DateTime(2020, 4, 8, 15, 46, 4, 356, DateTimeKind.Local).AddTicks(2617),
                            Source = "West Seattle Connection",
                            Title = "Party House"
                        },
                        new
                        {
                            ...
                            MainImageUrl = "https://static1.squarespace.com/static/53dd6676e4b0fedfbc26ea91/54b6c509e4b062126976d942/5a57a1d7c8302558ef0605cc/1516298184024/bike_girl_panning_bicycle_cycle_cyclist_outdoor_ride-1168194.jpg?format=2500w",
                            Published = new DateTime(2020, 4, 8, 15, 46, 4, 356, DateTimeKind.Local).AddTicks(2622),
                            Source = "West Seattle Connection",
                        ...
                        new
                        {
                            ...
                            MainImageUrl = "https://media-cdn.tripadvisor.com/media/photo-m/1280/14/ff/61/25/getlstd-property-photo.jpg",
                            Published = new DateTime(2020, 4, 8, 15, 46, 4, 356, DateTimeKind.Local).AddTicks(2626),
                            Source = "West Seattle Connection",
                        ...
                        new
                        {
                            ...
                            MainImageUrl = "https://static.seattletimes.com/wp-content/uploads/2020/03/03242020_bridge_134121-1560x1040.jpg",
                            Published = new DateTime(2020, 4, 8, 15, 46, 4, 356, DateTimeKind.Local).AddTicks(2632),
                            Source = "West Seattle Connection",
                            Title = "Our Bridge"
                        });
                });
            ...
            modelBuilder.Entity("ZineClient.Models.Zine", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Name = "Ctrl+V I",
                            OrganizationId = 2,
                            PublicationDate = new DateTime(2020, 4, 8, 15, 46, 4, 352, DateTimeKind.Local).AddTicks(1573)
                        },
                        new
                        {
                            ZineId = 2,
                            ...
                            Name = "Ctrl+V II",
                            OrganizationId = 2,
                            PublicationDate = new DateTime(2020, 4, 8, 15, 46, 4, 355, DateTimeKind.Local).AddTicks(6284)
                        },
                        new
                        {
                            ZineId = 3,
                            ...
                            Name = "Ctrl+V III",
                            OrganizationId = 2,
                            PublicationDate = new DateTime(2020, 4, 8, 15, 46, 4, 355, DateTimeKind.Local).AddTicks(6369)
                        },
                        new
                        {
                            ZineId = 4,
                            ...
                            Name = "Ctrl+C",
                            OrganizationId = 2,
                            PublicationDate = new DateTime(2020, 4, 8, 15, 46, 4, 355, DateTimeKind.Local).AddTicks(6376)
                        },
                        new
                        {
                            ZineId = 5,
                            ...
                            Name = "Devs Digest",
                            OrganizationId = 1,
                            PublicationDate = new DateTime(2020, 4, 8, 15, 46, 4, 355, DateTimeKind.Local).AddTicks(6381)
                        },
                        new
                        {
                            ZineId = 6,
                            ...
                            OrganizationId = 1,
                            PublicationDate = new DateTime(2020, 4, 8, 15, 46, 4, 355, DateTimeKind.Local).AddTicks(6385)
                        },
                        new
                        {
                            ZineId = 7,
                            ...
                            OrganizationId = 3,
                            PublicationDate = new DateTime(2020, 4, 8, 15, 46, 4, 355, DateTimeKind.Local).AddTicks(6389)
                        },
                        new
                        {
                            ZineId = 8,
                            ...
                            OrganizationId = 3,
                            PublicationDate = new DateTime(2020, 4, 8, 15, 46, 4, 355, DateTimeKind.Local).AddTicks(6394)
                        });
                });
